...
namespace GongSolutions.Wpf.DragDrop
{
    ...
    public class DefaultDragHandler : IDragSource
    {
        ...
        {
            throw new DragDropCanceledException();
        }
    ...
    public class DragDropCanceledException : Exception
    {
        public DragDropCanceledException()
        {
        }

        public DragDropCanceledException(string message)
            : base(message)
        {
        }

        public DragDropCanceledException(string message, Exception inner)
            : base(message, inner)
        {
        }
    }
